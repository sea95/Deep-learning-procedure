...
input_name = 'arti_input';                          % 'arti_input','arti_input_4', 'white_input_timehis','near_fault_input_linear'
                                                               % 'white_input_nonlinear'
output_name = 'arti_F_envelop';                    %  'arti_F_envelop','white_F_base_timehis',...
...
numHiddenUnits = 110;                                             % specify the hidden neurons
maxEpochs = 400;
miniBatchSize = 20 ;
...
featureDimension = size(data_summary.train_input{1},1);

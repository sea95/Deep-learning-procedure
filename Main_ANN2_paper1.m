...
input_name = 'near_fault_input';                          % 'arti_input', 'white_input_timehis'
output_name = 'near_fault_F_envelop';                   %  'arti_F_envelop','white_F_timehis',...
...
model_amount = 5;                                   % the total amount of trained models, and the final results corre. their average values.
...
numHiddenUnits = 250;                                           % specify the hidden neurons
maxEpochs = 500;
miniBatchSize = 20;
